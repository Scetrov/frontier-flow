...
2. The [release-please workflow](../.github/workflows/release-please.yml) opens or updates a release PR.
...
### 5.4 Patch Post-Release Verification
...
### 6.4 Minor Post-Release Verification
...
## 7. Major Release Runbook

Use a major release for breaking changes.

### 7.1 Qualifying Changes
...
### 7.4 Major Post-Release Verification
...
### 10.1 Release PR Did Not Appear

1. Confirm a releasable commit exists on `main`.
2. Confirm the [release-please workflow](../.github/workflows/release-please.yml) succeeded.
...
3. For especially important notes, add manual operator documentation in this `docs/` tree.

### 10.4 Broken Release After Merge
...
## 11. Maintainer Quick Checklists
