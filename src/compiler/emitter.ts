...
function createGenericPreamble(lines: string[], sourceMap: SourceMapEntry[]): void {
  ...
  pushLine(lines, sourceMap, "", null);
  pushLine(lines, sourceMap, "    const GROUP_SHUTTLE: u64 = 31;", null);
  pushLine(lines, sourceMap, "    const GROUP_CORVETTE: u64 = 237;", null);
  pushLine(lines, sourceMap, "    const GROUP_FRIGATE: u64 = 25;", null);
  pushLine(lines, sourceMap, "    const GROUP_DESTROYER: u64 = 420;", null);
  pushLine(lines, sourceMap, "    const GROUP_CRUISER: u64 = 26;", null);
  pushLine(lines, sourceMap, "    const GROUP_COMBAT_BATTLECRUISER: u64 = 419;", null);
  pushLine(lines, sourceMap, "", null);
  ...
  pushLine(lines, sourceMap, "        if (group_id == GROUP_COMBAT_BATTLECRUISER) { 6 }", null);
  pushLine(lines, sourceMap, "        else if (group_id == GROUP_CRUISER) { 5 }", null);
  pushLine(lines, sourceMap, "        else if (group_id == GROUP_DESTROYER) { 4 }", null);
  pushLine(lines, sourceMap, "        else if (group_id == GROUP_FRIGATE) { 3 }", null);
  pushLine(lines, sourceMap, "        else if (group_id == GROUP_CORVETTE) { 2 }", null);
  pushLine(lines, sourceMap, "        else if (group_id == GROUP_SHUTTLE) { 1 }", null);
